...
typedef enum levelCommand
{
    ...
    CMD_LEVEL_TYPE,
    CMD_LEVEL_UPDATEDLOGICSCRIPT,
    CMD_LEVEL_UPDATEDSCRIPT,
    CMD_LEVEL_UPDATELOGICSCRIPT,
...
typedef enum modelCommand
{
    ...
    CMD_MODEL_COLLISION_COORDINATES,
    ...
    CMD_MODEL_MODELLOADSCRIPT,
    CMD_MODEL_MODELUNLOADSCRIPT,
    ...
    CMD_MODEL_SLEEPWAIT,
    CMD_MODEL_SMARTBOMB,
    CMD_MODEL_SOUND_INDEX,
    CMD_MODEL_SOUND_CHANNEL_OFFSET,
    CMD_MODEL_SOUND_CHANNEL_PAUSE,
    CMD_MODEL_SOUND_CHANNEL_PRIORITY,
    CMD_MODEL_SOUND_CHANNEL_RESUME,
    CMD_MODEL_SOUND_CHANNEL_SET,
    CMD_MODEL_SOUND_CHANNEL_STOP,
    CMD_MODEL_SOUND_CHANCE,
    CMD_MODEL_SOUND_DELAY,
    CMD_MODEL_SOUND_GROUP,
    CMD_MODEL_SOUND_GROUP_OFFSET,
    CMD_MODEL_SOUND_GROUP_PAUSE,
    CMD_MODEL_SOUND_GROUP_RESUME,
    CMD_MODEL_SOUND_GROUP_STOP,
    CMD_MODEL_SOUND_LOADING,
    CMD_MODEL_SOUND_LOOP,
    CMD_MODEL_SOUND_LOOP_OFFSET,
    CMD_MODEL_SOUND_RANDOM,
    CMD_MODEL_SOUND_START_OFFSET,
    CMD_MODEL_SOUND,
...
typedef enum
{
    ...
    CMD_MODELSTXT_GLOBAL_CONFIG_DELAY_UNIT,
    ...
    CMD_MODELSTXT_GLOBAL_CONFIG_GAME_SPEED,
